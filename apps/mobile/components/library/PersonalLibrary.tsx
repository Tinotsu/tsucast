 ...
 * Personal Library
 *
 * Contains all authenticated-user library content: playlists, upgrade banner, and library items.
 * Extracted from library.tsx to allow conditional rendering based on auth state
 * without violating React rules of hooks.
 */
